...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: 'Led QA initiatives in the R&D-RDM-CBT (Payment & Ticketing) department, focusing on payment product validation. Key responsibilities included determining test objectives, reviewing specifications, creating test plans, and managing defects.',
  ...
  },
  {
    ...
    description: 'Designed and developed intranet applications to streamline and automate internal bank workflows. Gathered and analyzed requirements from various bank departments to create software solutions that improved efficiency and productivity.',
